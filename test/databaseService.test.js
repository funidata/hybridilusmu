...
describe('ChangeRegistration Tests', function() {
    ...
    it('Adding a normal registration works.', async function() {
    ...
    it('Removing a normal registration works.', async function() {
        let registrations = await db.getAllOfficeSignupsForADate('2021-10-21');
        assert.equal(1, registrations.length);
    ...
    it('Changing a normal registration works.', async function() {
        let registrations = await db.getAllOfficeSignupsForADate('2021-10-21');
        assert.equal(0, registrations.length);
        await service.changeRegistration('userId', '2021-10-21', true, true);
        registrations = await db.getAllOfficeSignupsForADate('2021-10-21');
    ...
    it('Adding a default registration works.', async function() {
    ...
    it('Removing a default registration works.', async function() {
        let registrations = await db.getAllOfficeDefaultSignupsForAWeekday('Torstai');
        assert.equal(1, registrations.length);
    ...
    it('Changing a default registration works.', async function() {
        let registrations = await db.getAllOfficeDefaultSignupsForAWeekday('Torstai');
        assert.equal(0, registrations.length);
        await service.changeDefaultRegistration('userId', 'Torstai', true, true);
        registrations = await db.getAllOfficeDefaultSignupsForAWeekday('Torstai');
...
describe('GetRegistrationsFor Tests', function() {
    ...
    it('Adding a normal registration and a default registration increases participant count by 2.', async function() {
    ...
    it('Adding a normal registration that matches with default registration, does not change anything.', async function() {
        await service.changeDefaultRegistration('userId', 'Torstai', true, true);
        let registrations = await service.getRegistrationsFor('2021-10-21');
        assert.equal(1, registrations.length);
        await service.changeRegistration('userId', '2021-10-21', true, true);
    ...
    it('Adding a normal registration with different value overwrites the default registration.', async function() {
        await service.changeRegistration('userId', '2021-10-21', true, false);
        registrations = await service.getRegistrationsFor('2021-10-21');
        assert.equal(0, registrations.length);
    });
    
    it('Changing default registration does not overwrite an already made normal registration.', async function() {
        await service.changeRegistration('userId', '2021-10-21', true, true);
        let registrations = await service.getRegistrationsFor('2021-10-21');
        assert.equal(1, registrations.length);
        await service.changeDefaultRegistration('userId', 'Torstai', true, false);
    ...
    it('Removing default registration does not remove an already made normal registration.', async function() {
        await service.changeDefaultRegistration('userId', 'Torstai', false);
        let registrations = await service.getRegistrationsFor('2021-10-21');
        assert.equal(1, registrations.length);
    ...
    it('Default registration registers if there is no normal registration for that day.', async function() {
        await service.changeDefaultRegistration('userId', 'Torstai', true, true);
        let registrations = await service.getRegistrationsFor('2021-10-21');
        assert.equal(1, registrations.length);
    });
